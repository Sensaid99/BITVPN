...
MESSAGES = {
    ...
    # Карточка «Моя подписка» (кнопки в боте после оплаты / по ссылке из мини-аппа)
    'my_subscription_card': (
        "🕹 <b>Моя подписка {brand}</b>\n\n"
        "⏰ <b>Статус подписки:</b> Active\n"
        "📅 <b>Действует до:</b> {end_date} <b>({days_left} дн.)</b>\n\n"
        "📌 Если кнопка «Подключиться» не работает, откройте эту ссылку в браузере:\n"
        "<a href=\"{link}\">{link_short}</a>\n\n"
        "👇 Либо нажмите «Подключиться» для автоматического открытия Happ."
    ),
    'my_subscription_card_wireguard': (
        "🕹 <b>Моя подписка {brand}</b>\n\n"
        "⏰ <b>Статус подписки:</b> Active\n"
        "📅 <b>Действует до:</b> {end_date} <b>({days_left} дн.)</b>\n\n"
        "📁 Конфигурация WireGuard отправлена файлом после оплаты. "
        "Импортируйте конфиг в приложение WireGuard."
    ),
    'my_subscription_card_no_link': (
        "🕹 <b>Моя подписка {brand}</b>\n\n"
        "⏰ <b>Статус подписки:</b> Active\n"
        "📅 <b>Действует до:</b> {end_date} <b>({days_left} дн.)</b>\n\n"
        "⚠️ Ссылка ещё не готова. Откройте мини-апп позже или напишите в поддержку."
    ),
    'payment_failed': (
    ...
    'happ_link_send_in_chat': "🔗 Ваша ссылка подписки (скопируйте и вставьте в Happ):",
    'happ_link_not_available_hint': "⚠️ Ссылку не удалось сгенерировать автоматически. Откройте приложение из меню бота и обновите страницу или напишите в поддержку.\n\n",
    ...
    # Уведомления об истечении подписки (рассылка по расписанию)
    'notification_expired': (
        "👋 Привет, {name}!\n\n"
        "⏳ Ваша подписка на VPN истекла и недоступна. ({end_date})\n\n"
        "👇 Продлите подписку по кнопке ниже, чтобы снова активировать доступ к сервису."
    ),
    'notification_expires_3d': (
        "👋 Привет, {name}!\n\n"
        "⏳ Ваша подписка на VPN истекает через 3 дня. ({end_date})\n\n"
        "👇 Продлите подписку по кнопке ниже, чтобы не потерять доступ."
    ),
    'notification_expires_1d': (
        "👋 Привет, {name}!\n\n"
        "⏳ Ваша подписка на VPN истекает завтра. ({end_date})\n\n"
        "👇 Продлите подписку по кнопке ниже, чтобы продолжить пользоваться VPN."
    ),
    'btn_pay_subscription': "💰 Оплатить подписку",
    'renew_via_app': (
        "Продлить подписку можно в приложении — нажмите кнопку ниже и выберите тариф."
    ),
